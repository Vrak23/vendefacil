  ...
  if (!product) {
    return (
      <div className="producto__not-found">
        <span className="producto__not-found-icon" aria-hidden="true">
          🔍
        </span>
      ...
      <div className="producto__container">
        ...
        <div className="producto__image-wrap">
          ...
          <div className="producto__image-badges">
            {isNew && (
              <span className="producto__badge producto__badge--new">
                Nuevo
              </span>
            )}
            {discount && (
              <span className="producto__badge producto__badge--sale">
                -{discount}%
              </span>
            )}
          </div>
        ...
        <div className="producto__info">
          {/* Categoría */}
          <span className="producto__category">{categoryName || category}</span>

          {/* Rating */}
          {reviews > 0 && (
            <div className="producto__rating">
              <div
                className="producto__stars"
              ...
              <span className="producto__rating-count">
                ({reviews} reseñas)
              </span>
            </div>
          )}
          ...
          <div className="producto__pricing">
            ...
            {originalPrice && (
              <span className="producto__price-original">
